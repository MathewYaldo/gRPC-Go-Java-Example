...
const (
	Hash_GetHash_FullMethodName = "/Hash/GetHash"
)
...
func (c *hashClient) GetHash(ctx context.Context, in *HashRequest, opts ...grpc.CallOption) (*HashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Hash_GetHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHashServer) GetHash(context.Context, *HashRequest) (*HashResponse, error) {
...
func _Hash_GetHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Hash_GetHash_FullMethodName,
	}
